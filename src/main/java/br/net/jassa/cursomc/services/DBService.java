...
import br.net.jassa.cursomc.domain.ItemPedido;
import br.net.jassa.cursomc.domain.Pagamento;
import br.net.jassa.cursomc.domain.PagamentoComBoleto;
import br.net.jassa.cursomc.domain.PagamentoComCartao;
...
import br.net.jassa.cursomc.domain.enums.Perfil;
...
import br.net.jassa.cursomc.repositories.EstadoRepository;
import br.net.jassa.cursomc.repositories.ItemPedidoRepository;
import br.net.jassa.cursomc.repositories.PagamentoRepository;
import br.net.jassa.cursomc.repositories.PedidoRepository;
import br.net.jassa.cursomc.repositories.ProdutoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "xxxxxxx@xxx.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323","93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "xxxxxx@xxx.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("93883815","99878784"));
		
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", "", "Centro", "28177012", cli2, c2);
